            ...
            <div className="container mx-auto">
                <ul className="list-none space-y-4">
                    <li className="shadow rounded p-4 hover:bg-gray-100">
                        ...
                        <section>
                            <h2>Kim jesteśmy?</h2>
                            <img src="http://138.68.158.146/media/about/Canceled-Flights.jpg" className="w-full h-96 object-cover mb-4 rounded"/>
                            ...
                            <h3>Nasza Usługa</h3>
                            <img src="http://138.68.158.146/media/about/jeshoots-com-mSESwdMZr-A-unsplash.jpg"                                 className="w-full h-96 object-cover mb-4 rounded"/>
                            ...
                            <h3>Dołącz do nas!</h3>
                            <img src="http://138.68.158.146/media/about/warsaw-transport-airport-AB-XL.jpg"
